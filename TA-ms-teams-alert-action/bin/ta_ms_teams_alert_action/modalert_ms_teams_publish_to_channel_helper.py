...
def process_event(helper, *args, **kwargs):
    ...
    # OpenURI action 2
    if (alert_ms_teams_potential_action_name2 is not None and alert_ms_teams_potential_action_url2 is not None):
    ...
    # HttpPOST action
    if (alert_ms_teams_potential_postaction_name is not None and alert_ms_teams_potential_postaction_target is not None):
    ...
    if has_action1 or has_action2 or has_postaction:
        ...
        if has_action1 and has_action2:
            ...
            data_json = data_json + '\"targets\": [' + '\n'
            data_json = data_json + '{\"os\": \"default\", \"uri\": \"' + alert_ms_teams_potential_action_url2 + '\"}' + '\n'
            data_json = data_json + ']\n' + '}\n'
